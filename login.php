<?php
require_once __DIR__.'/auth.php'; // Correctly reference the new auth.php
$error_message = "";
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (login_user($email, $password)) {
        // If successful, redirect them to the correct dashboard
        redirect_by_role();
    } else {
        // If unsuccessful, set an error message to display
